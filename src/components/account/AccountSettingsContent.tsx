...
/**
 * Contenu partagé de la page "Mon compte" (profil + mot de passe), utilisé
 * à la fois par /compte (espace pharmacie) et /admin/compte (console Super
 * Admin) pour éviter deux implémentations qui divergent.
 */
      ...
      <section className="grid grid-cols-1 gap-6 lg:grid-cols-[1fr_380px]">
        ...
        <aside className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <div className="mt-4 space-y-3 text-sm leading-6 text-slate-500">
            ...
            <p>
              • Chaque caissier, pharmacien ou comptable doit avoir son
              propre accès.
            </p>
          </div>
          ...
          <div className="mt-5 rounded-3xl border border-amber-100 bg-amber-50 p-4">
            ...
            <p className="mt-2 text-sm leading-6 text-amber-700">
              Après la première connexion, chaque utilisateur doit changer
